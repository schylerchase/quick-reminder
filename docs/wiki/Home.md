...
Quick Reminder is an Obsidian plugin for natural-language reminders, local notification scheduling, and Markdown-native task dashboards.
...
On a new install, run **Quick Reminder: Start with template dashboard**. This creates a replaceable starter board so new users can see a fully configured dashboard immediately.
